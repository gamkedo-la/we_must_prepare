...
function unitClass() {
    ...
    this.drawSelectionBox = function () {
        coloredOutlineRectCornerToCorner(this.x - UNIT_SELECTED_DIM_HALF,
                                         this.y - UNIT_SELECTED_DIM_HALF,
                                         this.x + UNIT_SELECTED_DIM_HALF,
                                         this.y + UNIT_SELECTED_DIM_HALF, 'green');
    }
    ...
    this.move = function() {
        ...
        } else if (this.playerControlled == false) { // end checking target, moving on to AI stuffs
            if (Math.random() < 0.02) {
